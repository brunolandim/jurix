...
// Type for moving a case (Trello style)
    ...
    cases: [
      {
        ...
        order: 1.0,
        assignee: "Dr. Carlos",
        assigneePhoto: '/img/homemSpider.jpg',
...
// Calculate new fractional order based on neighbors (Trello style)
...
// Sort cases by order (ensures consistency)
